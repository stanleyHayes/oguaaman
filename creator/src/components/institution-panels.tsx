      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <DatePicker id="org-event-date" className="w-full" value={startsAt} onChange={setStartsAt} />
          </div>
          <div>
        ...
        <div className="flex items-center gap-3">
          <button type="button" onClick={post} disabled={state === "saving" || !title.trim()} className="rounded-full bg-gold-brand px-5 py-2.5 text-sm font-semibold text-green-900 transition-colors hover:bg-gold disabled:opacity-60">
