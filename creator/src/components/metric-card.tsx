...
// Accents color foreground ink (icon, sub line, watermark) as well as the left
// border and tint, so green/maroon use the *-text tokens — identical in light,
// legible in dark. The rest already remap to bright-enough dark values.
const TONE_ACCENT: Record<MetricTone, string> = {
  green: "var(--color-green-text)",
  teal: "var(--color-teal)",
  gold: "var(--color-gold-brand)",
  clay: "var(--color-clay)",
  maroon: "var(--color-maroon-text)",
