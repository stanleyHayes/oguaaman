    ...
    <>
      ...
      <div className="relative z-10 px-4 pb-3 pt-4">
        <Link to="/" onClick={onNavigate} className="flex items-center gap-2.5 text-[0.9375rem] font-extrabold tracking-tight text-aura-cream">
          ...
          Oguaa
          <span className="font-mono text-[9px] uppercase tracking-[0.18em] text-aura-gold-muted">Creator</span>
        </Link>
      </div>
      ...
      <div className="flex min-h-screen flex-col lg:pl-60">
        <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b border-sand bg-cream/90 px-4 backdrop-blur sm:px-6">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-[0.62rem] font-bold uppercase tracking-[0.14em] text-ink-faint">Creator</p>
          ...
          <div className="relative hidden sm:block" ref={menuRef}>
            ...
            {userMenu && (
              <div role="menu" className="absolute right-0 z-20 mt-2 w-56 rounded-2xl border border-sand bg-paper p-2 shadow-lg">
                <Link to="/account" role="menuitem" onClick={() => setUserMenu(false)} className="block rounded-xl px-4 py-3 text-[0.9375rem] font-medium text-ink transition-colors hover:bg-cream">Profile</Link>
