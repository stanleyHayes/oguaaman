 ...
 * recovery codes. Adapted from the admin console (admin/src/components/mfa.tsx)
 * for the creator Settings security card.
 */
...
/** Disable flow with a current code — for the Settings security card. */
...
export function MfaManage() {
  ...
  return (
    <div className="space-y-3">
      <p className="text-sm text-ink-muted">Protect your studio with a second sign-in step — any authenticator app works.</p>
      <MfaEnroll />
    </div>
  );
}
