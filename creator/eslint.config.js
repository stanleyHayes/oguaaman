...
export default defineConfig([
  globalIgnores(['dist']),
  {
    ...
    rules: {
      ...
      // context + its useAuth hook) legitimately export a helper alongside a
      // component; we surface the hint without blocking CI. Every correctness
      // rule remains a hard error.
