...
FLYERS = [
 dict(key="music", photo="fetu-crowd.jpg", tone=CLAY, motif="sankofa",
      ...
      title="Claim your\nplace in the\nOguaa sound.",
      body="Are you an artist from Cape Coast? Create a free profile — your bio, your genres, your releases — and we point listeners straight to Audiomack, Boomplay, Spotify and YouTube. We send people to you. We don't host your music, and we never touch your streams.",
 ...
 dict(key="business", photo="market-women.jpg", tone=TEAL, motif="funtunfunefu",
      ...
      title="Put your shop\non the map\nof Oguaa.",
      body="Every Cape Coast business can list here, free — market traders, seamstresses, mechanics, guesthouses. Add what you sell, your prices and your WhatsApp, and let the town and the diaspora find you. Be one of the first on the map.",
 ...
 dict(key="storefront", photo="kenkey-fish.jpg", tone=TEAL, motif="funtunfunefu",
      ...
      title="A shopfront\nthat never\ncloses.",
      body="Open one in minutes: photos, opening hours, a full product and service catalogue, and reviews from real neighbours. One clean link to share — oguaaman.com/s/your-shop — that works on every phone in town, and every item gets its own page on Google.",
      cta="oguaaman.com · Business"),
 dict(key="lostfound", photo="downtown.jpg", tone=TEAL, motif="nkyinkyim",
      eyebrow="Neighbour to neighbour",
      title="Lost it?\nPost it.\nNow.",
      body="Lost something, found something, or looking for someone? Post a notice and it goes live immediately — no waiting for approval — because the right neighbour may already have the answer.",
      cta="oguaaman.com · Lost & Found"),
 dict(key="safety", photo="fosu-lagoon.jpg", tone=MAROON, motif="nkyinkyim",
      eyebrow="Keeping Oguaa safe",
      title="One place\nfor what's\nhappening.",
      body="Report an incident, follow what happens next, and get alerts from recognised authorities rather than rumours in a group chat. Flooding, fire, a road closed — one place the whole town can rely on.",
 ...
 dict(key="memoriam", photo="christ-church.jpg", tone=GOLD_DEEP, motif="gye-nyame",
      ...
      title="A permanent\nhome for\ntheir story.",
      body="Create a lasting page for someone you have lost — photographs, tributes, and a candle anyone can light. Family-guided, reviewed for dignity, and here for good. Not a post that scrolls away.",
 ...
 dict(key="outside", photo="fishing-boats.jpg", tone=GOLD_DEEP, motif="funtunfunefu",
      ...
      title="Someone you\ncan trust,\nback home.",
      body="Errands for Cape Coast people abroad — procurement, shipping, inspections, official paperwork — handled by background-checked agents, with the money held in escrow until the job is done. Register what you need, or apply to become an agent.",
 ...
 dict(key="youth", photo="outdoor-classroom-ghana.jpg", tone=TEAL, motif="funtunfunefu",
      ...
      title="Open a door\nfor someone\nyoung.",
      body="Running a scholarship, apprenticeship, internship or training place? Post it free and put it in front of the young people of Cape Coast. Information and outbound links only — no private adult-to-minor contact ever runs through Oguaaman.",
 ...
 dict(key="projects", photo="classroom-block-ghana.jpg", tone=GREEN, motif="funtunfunefu",
      ...
      body="Propose a costed, concrete improvement for Cape Coast — a library corner, a lagoon clean-up, an ICT lab — and let the town and the diaspora fund it. Every cedi receipted, every project accountable to the people it serves.",
 ...
 dict(key="rent", photo="castle-courtyard.jpg", tone=GOLD_DEEP, motif="funtunfunefu",
      ...
      body="Letting a room, a house or a guest stay in Cape Coast? List it free for the students, workers and family coming home who are looking right now.",
