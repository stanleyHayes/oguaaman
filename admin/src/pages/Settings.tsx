    ...
    <Section title="Operations" description="Manual tools the daily scheduler also runs.">
      <div className="rounded-lg border border-sand bg-paper p-4">
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2">
          ...
          <button type="button" onClick={run} disabled={busy} className="rounded-full bg-green px-5 py-2.5 text-sm font-semibold text-on-green transition-colors hover:bg-green-900 disabled:opacity-60">
    ...
    <>
      ...
      <Section title="Account & security" description="How you sign in and protect your steward access." className="mb-5">
        <div className="grid gap-4 sm:grid-cols-[1fr_auto] sm:items-center">
          ...
          <button type="button" onClick={signOut} className="rounded-full border border-maroon-text/50 px-5 py-2.5 text-sm font-semibold text-maroon-text transition-colors hover:bg-maroon-900/[0.06]">
            Sign out
          </button>
        </div>
      </Section>
