 ...
 * still: no entering animations, no parallax, no press scaling. All helpers
 * run on native and on the web export (Reanimated v4 layout animations and
 * scroll handlers support react-native-web).
 */
