...
const makeStyles = (C: Palette) => StyleSheet.create({
  ...
  heroStatus: { color: ON_GREEN, fontSize: 12, ...D(700), letterSpacing: 1, textTransform: "uppercase", marginTop: 10 },
  body: { padding: 20 },
  ...
  currentLabel: { color: C.inkFaint, fontSize: 10, letterSpacing: 2, ...S(700) },
