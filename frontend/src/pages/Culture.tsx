    ...
    <>
      ...
      <section className="relative overflow-hidden border-b border-sand bg-paper py-16 sm:py-24">
        ...
        <Container className="relative grid gap-10 lg:grid-cols-[0.65fr_1.35fr]">
          ...
          <Reveal delay={0.08}><p className="max-w-[45rem] text-lg font-medium leading-[1.65] text-ink sm:text-xl">{CULTURE_BLURB}</p></Reveal>
        </Container>
      </section>

      <section id="fetu" className="scroll-mt-24 bg-cream py-16 sm:py-24">
        <Container size="wide">
          <div className="on-dark on-dark-pin grid overflow-hidden rounded-[2rem] bg-green-900 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            <Reveal className="flex flex-col justify-center p-8 text-cream sm:p-12 lg:p-14"><Eyebrow className="text-gold">The anchor festival</Eyebrow><h2 className="mt-4 text-3xl font-semibold text-cream sm:text-4xl">Oguaa Fetu Afahye</h2><p className="mt-5 max-w-xl text-base leading-relaxed text-cream/75 sm:text-lg">The harvest and cleansing festival reaches its height on the first Saturday of September: a grand durbar, chiefs beneath state umbrellas, Asafo processions and the city gathered around its traditional authority.</p><dl className="mt-7 grid grid-cols-2 gap-px overflow-hidden rounded-xl bg-cream/15"><div className="bg-green-900/50 p-4"><dt className="text-xs uppercase tracking-widest text-cream/50">2026 climax</dt><dd className="mt-1 font-semibold text-gold">5 September</dd></div><div className="bg-green-900/50 p-4"><dt className="text-xs uppercase tracking-widest text-cream/50">Meaning</dt><dd className="mt-1 font-semibold text-gold">Clearing the dirt</dd></div></dl><div className="mt-7"><Cta to="/festivals" variant="gold">Explore festival editions →</Cta></div></Reveal>
          </div>
        </Container>
      </section>
