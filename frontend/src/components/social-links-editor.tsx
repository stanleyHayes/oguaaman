...
const input = "min-h-11 w-full rounded-xl border border-sand bg-paper px-3.5 py-2.5 text-ink placeholder:text-ink-faint focus:border-green focus:outline-none focus:ring-2 focus:ring-green/15";
...
export function SocialLinksEditor({ links, onChange, title = "Social media and website" }: Readonly<{ links: SocialLink[]; onChange: (links: SocialLink[]) => void; title?: string }>) {
  return <section className="rounded-2xl border border-sand bg-cream p-4 sm:p-5">
    <p className="eyebrow text-teal-text">Official pages</p>
