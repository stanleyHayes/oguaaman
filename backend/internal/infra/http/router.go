...
func NewRouter(h *Handler, gql http.Handler, allowedOrigins []string, log *slog.Logger) http.Handler {
	...
	// Public "forgot password" flow — issue a reset code, then set a new password.
	...
	// Verified business commerce: private KYC, Paystack subaccount splits,
	// product checkout, orders and owner-managed coupon promotions.
	mux.HandleFunc("POST /api/listings/{id}/business-verification", h.SubmitBusinessVerification)
	mux.HandleFunc("GET /api/listings/{id}/business-verification", h.BusinessVerification)
	mux.HandleFunc("GET /api/admin/business-verifications", h.AdminBusinessVerifications)
	mux.HandleFunc("POST /api/admin/business-verifications/{id}/review", h.AdminReviewBusinessVerification)
	mux.HandleFunc("POST /api/businesses/{slug}/orders", h.StartCommerceOrder)
	mux.HandleFunc("GET /api/businesses/{slug}/commerce-status", h.BusinessCommerceStatus)
	mux.HandleFunc("GET /api/orders/confirm", h.ConfirmCommerceOrder)
	mux.HandleFunc("GET /api/me/orders", h.MyCommerceOrders)
	mux.HandleFunc("GET /api/listings/{id}/orders", h.BusinessCommerceOrders)
	mux.HandleFunc("POST /api/listings/{id}/orders/{orderId}/status", h.SetCommerceOrderStatus)
	mux.HandleFunc("GET /api/admin/orders", h.AdminCommerceOrders)
	mux.HandleFunc("GET /api/listings/{id}/coupons", h.BusinessCoupons)
	mux.HandleFunc("POST /api/listings/{id}/coupons", h.BusinessCoupons)
	mux.HandleFunc("DELETE /api/listings/{id}/coupons/{couponId}", h.DeleteBusinessCoupon)
	mux.HandleFunc("GET /api/listings/{id}/affiliate-programmes", h.AffiliateProgrammes)
	mux.HandleFunc("POST /api/listings/{id}/affiliate-programmes", h.AffiliateProgrammes)
	mux.HandleFunc("GET /api/listings/{id}/affiliates", h.Affiliates)
	mux.HandleFunc("POST /api/listings/{id}/affiliates", h.Affiliates)
	mux.HandleFunc("GET /api/listings/{id}/affiliate-conversions", h.AffiliateConversions)
	mux.HandleFunc("GET /api/admin/commerce-promotions", h.AdminCommercePromotions)
	mux.HandleFunc("POST /api/admin/commerce-promotions", h.AdminCommercePromotions)
	mux.HandleFunc("GET /api/admin/affiliate-programmes", h.AdminAffiliateProgrammes)
	mux.HandleFunc("POST /api/admin/affiliate-programmes", h.AdminAffiliateProgrammes)
	mux.HandleFunc("GET /api/admin/affiliates", h.AdminAffiliates)
	mux.HandleFunc("POST /api/admin/affiliates", h.AdminAffiliates)
	mux.HandleFunc("GET /api/admin/affiliate-conversions", h.AdminAffiliateConversions)
	mux.HandleFunc("POST /api/admin/affiliate-conversions/{id}/status", h.AdminAffiliateConversionStatus)
