...
func Seed(ctx context.Context, db *mongo.Database) error {
	for _, name := range []string{collMembers, collOrgs, collPlaces, collListings, collModeration, collOtps, collNotifications, collFollows, collMemberFollows, collOrgClaims, collNews, collReports, collAIUsage, collPledges, collTickets, collSubscriptions, collPromotions, collTimeline} {
		if err := db.Collection(name).Drop(ctx); err != nil {
			return err
		}
	}
	if err := insertAll(ctx, db.Collection(collMembers), seedMembers); err != nil {
		return err
	}
...
var seedNews = []domain.NewsArticle{
	...
	},
	{
		...
		Status:  domain.NewsPublished, AuthorID: memberAkua, AuthorName: newsroomName, CoverColor: colorDeepGreen,
...
var seedOrgs = []domain.Organization{
	{ID: "mfantsipim", Slug: "mfantsipim", Kind: "school", Name: "Mfantsipim School", Motto: "Dwen Hwe Kan — Think and Look Ahead", Founded: 1876, Classification: "Senior High (Methodist, boys)", Summary: "Founded 3 April 1876 as the Wesleyan High School — the oldest secondary school in Ghana, which marked its 150th year in 2026.", History: "From its Cape Coast hill, Mfantsipim has shaped the nation's leaders, most famously the late UN Secretary-General Kofi Annan. Its rivalry with Adisadel is the oldest in Ghana.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedSchoolsBatch, HouseColors: []string{colorCrimson, colorInk}, OSAName: "MOBA", MemberCount: 318, RelatedOrgIDs: []string{"moba", orgOguaaTraditional}, Offices: []domain.Office{{ID: "o-mfan-head", Role: "Headmaster", HolderName: "Mr. K. A. Sagoe", Verified: true}, {ID: "o-mfan-moba", Role: "MOBA President", HolderName: "Dr. E. Brew", Verified: true}},
		...
		Sections: []domain.ProfileSection{
			...
			{ID: "sec-mfan-facilities", Type: "gallery", Title: "Facilities", Tone: "teal", Media: []domain.MediaAsset{
				{ID: "med-mfan-lib", Kind: "photo", Alt: "The school library", Caption: "Aggrey Memorial Library", Moderation: "approved"},
				{ID: "med-mfan-lab", Kind: "photo", Alt: "A science laboratory", Caption: "Science laboratories", Moderation: "approved"},
				{ID: "med-mfan-class", Kind: "photo", Alt: "A classroom block", Caption: "Classrooms", Moderation: "approved"},
				{ID: "med-mfan-hall", Kind: "photo", Alt: "The assembly hall", Caption: "Assembly hall", Moderation: "approved"},
			}},
	...
	{ID: "adisadel", Slug: "adisadel", Kind: "school", Name: "Adisadel College", Motto: "Vel primus vel cum primis — Either the first or with the first", Founded: 1910, Classification: "Senior High (Anglican, boys)", Summary: "Founded 4 January 1910 as the SPG Grammar School; named St. Nicholas' in 1924 and Adisadel on its hilltop site around 1936 — hence the 'Santaclausians.'", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedSchoolsBatch, HouseColors: []string{colorInk, colorPaper}, OSAName: "Santaclausians", MemberCount: 241, Offices: []domain.Office{{ID: "o-adi-head", Role: "Headmaster", HolderName: "Rev. S. Quaye", Verified: true}}},
	{ID: schoolWesleyGirls, Slug: schoolWesleyGirls, Kind: "school", Name: "Wesley Girls' High School", Motto: "Live Pure, Speak True, Right Wrong, Follow the King", Founded: 1836, Classification: "Senior High (Methodist, girls)", Summary: "Traced to 1836 under Harriet Wrigley and reorganised into today's school around 1954 — a by-word for poise and excellence.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedSchoolsBatch, HouseColors: []string{colorGreen, colorGold}, OSAName: "Wey Gey Hey OGA", MemberCount: 277, Offices: []domain.Office{{ID: "o-wghs-head", Role: "Headmistress", HolderName: "Mrs. A. Ofosu", Verified: true}}},
	{ID: "st-augustines", Slug: "st-augustines", Kind: "school", Name: "St. Augustine's College", Motto: "Omnia Vincit Labor — Perseverance conquers all", Founded: 1930, Classification: "Senior High (Catholic, boys)", Summary: "Founded 1930; the Augustinians' green and white come from the Irish flag of its founding fathers.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedSchoolsBatch, HouseColors: []string{colorLeafGreen, colorPaper}, OSAName: "APSU", MemberCount: 156, Offices: []domain.Office{{ID: "o-aug-head", Role: "Headmaster", HolderName: "Mr. P. Mensah", Verified: true}}},
	{ID: schoolHolyChild, Slug: schoolHolyChild, Kind: "school", Name: "Holy Child School", Motto: "Facta Non Verba — Actions Not Words", Founded: 1946, Classification: "Senior High (Catholic, girls)", Summary: "Founded 1946 by the Society of the Holy Child Jesus; known with affection as 'Angel's Hill.'", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedSchoolsBatch, HouseColors: []string{colorBrown, colorGold}, OSAName: "HOPSA", MemberCount: 132, Offices: []domain.Office{{ID: "o-hc-head", Role: "Headmistress", HolderName: "Mrs. G. Esson", Verified: true}}},
	{ID: "ucc", Slug: "ucc", Kind: "school", Name: "University of Cape Coast", Motto: "Veritas Nobis Lumen — Truth, Our Guide", Founded: 1962, Classification: "Public university", Summary: "Opened as a university college in October 1962 and attained full, independent university status on 1 October 1971. Its Department of Music and Dance (est. 1975) keeps the Oguaa pipeline flowing.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedSchoolsBatch, HouseColors: []string{colorCobalt, colorBrass}, OSAName: "UCC Alumni", MemberCount: 402, Offices: []domain.Office{{ID: "o-ucc-vc", Role: "Vice-Chancellor", HolderName: "Prof. (office)", Verified: true}}},
	{ID: schoolBakaanoBasic, Slug: schoolBakaanoBasic, Kind: "school", Name: "Bakaano M/A Basic School", Motto: "Knowledge and Service", Founded: 1957, Classification: "KG · Primary · JHS", Summary: "A public basic school in Bakaano, Cape Coast, serving the lagoon-side community for over six decades. Recognised by the Ghana Education Service under the Cape Coast Metropolitan Education Directorate. Languages of instruction: English and Fante.", Jurisdiction: "Bakaano, Cape Coast", Verified: true, VerifiedOn: verifiedSchoolsBatch, HouseColors: []string{colorDeepGreen, colorBrass}, MemberCount: 412, RelatedOrgIDs: []string{orgOguaaTraditional}, Offices: []domain.Office{{ID: "o-bak-head", Role: "Headteacher", HolderID: memberAidoo, HolderName: "Mr. Samuel Aidoo", Verified: true}, {ID: "o-bak-asst", Role: "Assistant Head", HolderName: "Mrs. Grace Otoo", Verified: true}, {ID: "o-bak-pta", Role: "PTA Chairperson", HolderID: memberNana, HolderName: "Nana Kweku Essien", Verified: true}}},
...
var seedExtraOrgs = []domain.Organization{
	...
	{ID: "ghana-national-college", Slug: "ghana-national-college", Kind: "school", Name: "Ghana National College", Motto: "Pro Patria", Founded: 1948, Classification: "Senior High (co-ed, public)", Summary: "Founded in 1948 by Dr. Kwame Nkrumah to school students expelled from the mission colleges for backing the independence struggle — fondly remembered as Osagyefo's own school.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorCrimson, colorCobalt}, OSAName: "Nananom (Past Students)"},
	{ID: "aggrey-memorial", Slug: "aggrey-memorial-ame-zion-shs", Kind: "school", Name: "Aggrey Memorial A.M.E. Zion Senior High School", Motto: "Semper Optimo Nitere", Founded: 1940, Classification: "Senior High (co-ed, public, A.M.E. Zion)", Summary: "Opened in 1940 to honour the scholar Dr. James Kwegyir Aggrey and later run by the A.M.E. Zion Church — among Cape Coast's earliest co-educational schools.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorMaroon, colorBrass}, OSAName: "Aggrey Memorial OSA"},
	{ID: "oguaa-shts", Slug: "oguaa-senior-high-technical", Kind: "school", Name: "Oguaa Senior High Technical School", Founded: 1991, Classification: "Technical/Vocational Senior High (co-ed, public)", Summary: "Begun in 1991 and relocated to Ekon in 1997, OSTECH blends technical and academic streams for the town's young people.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorTeal, colorBrass}, OSAName: "OSTECH OSA"},
	{ID: "academy-christ-king", Slug: "academy-of-christ-the-king", Kind: "school", Name: "Academy of Christ the King Senior High School", Founded: 1976, Classification: "Senior High (co-ed, public, Anglican)", Summary: "Established in 1976 by the Mothers' Union of the Anglican Church — one of the metropolis's well-regarded co-educational senior high schools.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorCobalt, colorPaper}, OSAName: "ACKOSA"},
	{ID: "cctu", Slug: "cape-coast-technical-university", Kind: "school", Name: "Cape Coast Technical University", Founded: 1984, Classification: "Technical University (public)", Summary: "Founded in 1984 as Cape Coast Polytechnic and elevated to a technical university in 2016, training engineers, technicians and applied-science professionals for the Central Region.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorCobalt, colorBronze}, OSAName: "CCTU Alumni"},
	{ID: "ola-college", Slug: "ola-college-of-education", Kind: "school", Name: "OLA College of Education", Founded: 1924, Classification: "College of Education (women, Catholic; UCC-affiliated)", Summary: "Established in 1924 by the Missionary Sisters of Our Lady of Apostles — the first women's teacher-training college in Ghana and sub-Saharan Africa, which marked its centenary in 2024.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorRoyalBlue, colorPaper}},
	{ID: "cc-deaf-blind", Slug: "cape-coast-school-for-the-deaf-and-blind", Kind: "school", Name: "Cape Coast School for the Deaf and Blind", Motto: "Disability is not Inability", Founded: 1970, Classification: "Special school (deaf & visually-impaired)", Summary: "Opened in 1970 with fifteen pupils on the Cape Coast–Takoradi highway; a government special school for deaf and, later, visually-impaired children of the region.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorLeafGreen, colorBrass}},
	{ID: "philip-quaque-boys", Slug: "philip-quaque-boys-school", Kind: "school", Name: "Philip Quaque Boys' School", Motto: "Nyansa ahyese nye nyamesuro", Founded: 1766, Classification: "Basic (KG/Primary/JHS; Anglican-founded)", Summary: "Founded beside Cape Coast Castle in 1766 by the Rev. Philip Quaque, the first African Anglican priest — widely honoured as the oldest formal European-style school in Ghana.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorMaroon, colorBrass}},
	{ID: "st-monicas-basic", Slug: "st-monicas-basic-school-cape-coast", Kind: "school", Name: "St. Monica's Basic School, Cape Coast", Motto: "Each for all and all for God", Founded: 1926, Classification: "Basic (KG/Primary/JHS; Anglican)", Summary: "Established on Aboom Road in 1926 by the Anglican Sisters of the Order of the Holy Paraclete as their first Gold Coast school.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorBrown, colorGold}, OSAName: "Union of Old St Monicans"},
