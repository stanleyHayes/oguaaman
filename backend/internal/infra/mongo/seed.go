...
func createIndexes(ctx context.Context, db *mongo.Database) error {
	...
	if _, err := db.Collection(collMemberBlocks).Indexes().CreateMany(ctx, []mongo.IndexModel{
		idx(bson.D{{Key: "blockerId", Value: 1}, {Key: "blockedId", Value: 1}}),
		idx(bson.D{{Key: "blockedId", Value: 1}}),
	}); err != nil {
		return err
	}
...
var seedMembers = []domain.Member{
	...
	{ID: "m-yaw", Slug: "yaw-ofori", PhotoURL: avatar("yaw-ofori"), DisplayName: "Yaw Ofori", Initials: "YO", Bio: "Manages Castle View Guesthouse and homes across Cape Coast.", TownID: "oguaa", SchoolIDs: []string{"adisadel"}, PhoneVerified: true, Role: "member", CreatorTypes: []string{domain.CreatorBusiness, domain.CreatorProperty}, JoinedAt: "2026-02-14", Phone: "+233240000007", Email: "yaw-ofori@oguaa.test"},
	...
	// The diaspora register (spec §4/§5/§15, Phase 2) — sons & daughters opted in
	// as living away from home. "Abroad" includes elsewhere in Ghana (spec §5).
	{ID: "m-kwabena", Slug: "kwabena-mensah", PhotoURL: avatar("kwabena-mensah"), DisplayName: "Kwabena Mensah", Initials: "KM", Bio: "MOBA '98. Runs a Ghanaian grocery in Peckham; sends the barrels home every December.", TownID: "oguaa", SchoolIDs: []string{"mfantsipim"}, Schooling: []domain.SchoolStint{{SchoolID: "mfantsipim", FromYear: 1994, ToYear: 1998}}, PhoneVerified: true, Role: "member", JoinedAt: d20260120, Phone: "+447700900001", Email: "kwabena-mensah@oguaa.test", Diaspora: &domain.Diaspora{Abroad: true, City: "London", Country: "United Kingdom"}},
	{ID: "m-akosua", Slug: "akosua-biney", PhotoURL: avatar("akosua-biney"), DisplayName: "Akosua Biney", Initials: "AB", Bio: "Wey Gey Hey. Nurse in the Bronx — home every Afahye since 2016.", TownID: "bakaano", SchoolIDs: []string{schoolWesleyGirls}, PhoneVerified: true, Role: "member", JoinedAt: "2026-02-11", Phone: "+17185550101", Email: "akosua-biney@oguaa.test", Diaspora: &domain.Diaspora{Abroad: true, City: "New York", Country: "United States"}},
	{ID: "m-yaw-darko", Slug: "yaw-darko", PhotoURL: avatar("yaw-darko"), DisplayName: "Yaw Darko", Initials: "YD", Bio: "Santaclausian. Software engineer; coaches the Ghanaian community league in Toronto.", TownID: "oguaa", SchoolIDs: []string{"adisadel"}, Schooling: []domain.SchoolStint{{SchoolID: "adisadel", FromYear: 2001, ToYear: 2005}}, PhoneVerified: true, Role: "member", JoinedAt: d20260301, Phone: "+14165550101", Email: "yaw-darko@oguaa.test", Diaspora: &domain.Diaspora{Abroad: true, City: "Toronto", Country: "Canada"}},
	{ID: "m-efua-arkoh", Slug: "efua-arkoh", PhotoURL: avatar("efua-arkoh"), DisplayName: "Efua Arkoh", Initials: "EA", Bio: "HOPSAN. Port logistics in Hamburg — still Kotokuraba at heart.", TownID: "kotokuraba", AsafoID: "asafo-anaafo", SchoolIDs: []string{schoolHolyChild}, PhoneVerified: true, Role: "member", JoinedAt: d20260401, Phone: "+4915155550101", Email: "efua-arkoh@oguaa.test", Diaspora: &domain.Diaspora{Abroad: true, City: "Hamburg", Country: "Germany"}},
	{ID: "m-papa-kwesi", Slug: "papa-kwesi-grant", PhotoURL: avatar("papa-kwesi-grant"), DisplayName: "Papa Kwesi Grant", Initials: "PG", Bio: "UCC '05. Teacher; organises the Holland chapter's Afahye watch party.", TownID: "oguaa", SchoolIDs: []string{"ucc"}, PhoneVerified: true, Role: "member", JoinedAt: "2026-05-09", Phone: "+31655501010", Email: "papa-kwesi-grant@oguaa.test", Diaspora: &domain.Diaspora{Abroad: true, City: "Amsterdam", Country: "Netherlands"}},
	{ID: "m-abena", Slug: "abena-quainoo", PhotoURL: avatar("abena-quainoo"), DisplayName: "Abena Quainoo", Initials: "AQ", Bio: "Wey Gey Hey. Banker in Accra — away from home, never far. Back most weekends.", TownID: "bakaano", SchoolIDs: []string{schoolWesleyGirls}, PhoneVerified: true, Role: "member", JoinedAt: "2026-05-22", Phone: "+233240000011", Email: "abena-quainoo@oguaa.test", Diaspora: &domain.Diaspora{Abroad: true, City: "Accra", Country: "Ghana"}},
}
...
var seedExtraOrgs = []domain.Organization{
	...
	// ── More Cape Coast schools (basic, SHS, technical/vocational) ─────────────
	// Lightweight registry entries so the Education/institutions directory is
	// comprehensive: no hand-authored schoolPage/Sections, no crest (the UI falls
	// back to initials). Demo data — figures/details are plausible, never presented
	// as official records. A claimed school fills in the rest from the dashboard.
	//
	// Senior High & technical/vocational.
	{ID: "university-practice-shs", Slug: "university-practice-shs", Kind: "school", Name: "University Practice Senior High School", Founded: 1979, Classification: "Senior High · quasi-public, co-ed", Summary: "Set up in October 1979 on the University of Cape Coast campus at Kwaprow as the Faculty of Education's teaching-practice and demonstration senior high school. A quasi-public, co-educational school where UCC's trainee teachers gain supervised classroom experience.", Jurisdiction: "Kwaprow (UCC campus), Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorCobalt, colorBrass}},
	{ID: "efutu-shts", Slug: "efutu-shts", Kind: "school", Name: "Efutu Senior High Technical School", Founded: 1999, Classification: "Senior High (technical) · public, co-ed", Summary: "A public co-educational senior high with technical programmes at Efutu, on the Cape Coast–Kakum road. Started in 1999 as a community day school and absorbed into the Ghana Education Service in 2001.", Jurisdiction: "Efutu, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorTeal, colorGold}},
	{ID: "cape-coast-technical-institute", Slug: "cape-coast-technical-institute", Kind: "school", Name: "Cape Coast Technical Institute", Classification: "Technical/Vocational · public, co-ed", Summary: "A long-established public technical and vocational institute in Cape Coast offering engineering, business and ICT trades; absorbed into the national technical-education system in 1976.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorTeal, colorBrass}},
	{ID: "social-welfare-girls-vtc", Slug: "social-welfare-girls-vtc", Kind: "school", Name: "Social Welfare Girls' Vocational Training Centre", Classification: "Technical/Vocational · quasi-public, girls", Summary: "A quasi-public vocational training centre for girls run by the Department of Social Welfare in Cape Coast, teaching catering and dressmaking skills.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorClay, colorGold}},
	{ID: "gratis-technical-institute-cape-coast", Slug: "gratis-technical-institute-cape-coast", Kind: "school", Name: "GRATIS Technical Institute, Cape Coast", Classification: "Technical/Vocational · quasi-public, co-ed", Summary: "A quasi-government technical centre of the GRATIS Foundation in Cape Coast, offering engineering and apprenticeship skills training.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorTeal, colorBronze}},
	//
	// Basic schools — mission.
	{ID: "aboom-ame-zion-c-basic", Slug: "aboom-ame-zion-c-basic", Kind: "school", Name: "Aboom A.M.E. Zion 'C' Basic School", Classification: "Basic school · A.M.E. Zion (mission), co-ed", Summary: "An A.M.E. Zion mission basic school in the Aboom quarter of Cape Coast, taking co-educational classes from kindergarten through junior high. One of several A.M.E. Zion schools in the town, it is distinct from the Aggrey Memorial A.M.E. Zion senior high. Languages of instruction: English and Fante.", Jurisdiction: "Aboom, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorMaroon, colorBrass}},
	{ID: "wesley-girls-basic", Slug: "wesley-girls-basic", Kind: "school", Name: "Wesley Girls' Basic School", Classification: "Basic school · Methodist (mission), girls", Summary: "A Methodist mission girls' basic school in Cape Coast. Languages of instruction: English and Fante.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorGreen, colorGold}},
	{ID: "christ-church-anglican-basic", Slug: "christ-church-anglican-basic", Kind: "school", Name: "Christ Church Anglican Basic School", Classification: "Basic school · Anglican (mission), co-ed", Summary: "An Anglican mission basic school at Chapel Square, Cape Coast, taking co-educational classes from kindergarten through junior high. Languages of instruction: English and Fante.", Jurisdiction: "Chapel Square, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorRoyalBlue, colorPaper}},
	{ID: "st-nicholas-anglican-basic", Slug: "st-nicholas-anglican-basic", Kind: "school", Name: "St. Nicholas Anglican Basic School", Classification: "Basic school · Anglican (mission), co-ed", Summary: "An Anglican mission basic school in Cape Coast, running primary and junior high classes. Languages of instruction: English and Fante.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorRoyalBlue, colorGold}},
	{ID: "amanful-catholic-boys-basic", Slug: "amanful-catholic-boys-basic", Kind: "school", Name: "Amanful Catholic Boys' Basic School", Classification: "Basic school · Catholic (mission), boys", Summary: "A Catholic mission boys' basic school in the Amanful quarter of Cape Coast. Languages of instruction: English and Fante.", Jurisdiction: "Amanful, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorLeafGreen, colorPaper}},
	{ID: "st-lawrence-catholic-a-basic", Slug: "st-lawrence-catholic-a-basic", Kind: "school", Name: "St. Lawrence Catholic 'A' Basic School", Classification: "Basic school · Catholic (mission), co-ed", Summary: "A Catholic mission basic school in Cape Coast, paired with St. Lawrence 'B'. Languages of instruction: English and Fante.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorLeafGreen, colorGold}},
	{ID: "st-marys-catholic-girls-basic", Slug: "st-marys-catholic-girls-basic", Kind: "school", Name: "St. Mary's Catholic Girls' Basic School", Classification: "Basic school · Catholic (mission), girls", Summary: "A Catholic mission girls' basic school in Cape Coast. Languages of instruction: English and Fante.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorBrass, colorMaroon}},
	{ID: "ola-catholic-girls-jhs", Slug: "ola-catholic-girls-jhs", Kind: "school", Name: "OLA Catholic Girls' JHS", Classification: "Basic school (JHS) · Catholic (mission), girls", Summary: "A Catholic girls' junior high school in the OLA (Our Lady of the Apostles) enclave of Cape Coast. Languages of instruction: English and Fante.", Jurisdiction: "OLA Estate, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorRoyalBlue, colorBrass}},
	{ID: "cape-coast-presbyterian-basic", Slug: "cape-coast-presbyterian-basic", Kind: "school", Name: "Cape Coast Presbyterian Basic School", Classification: "Basic school · Presbyterian (mission), co-ed", Summary: "A Presbyterian mission basic school in Cape Coast, taking pupils from primary through junior high. Languages of instruction: English and Fante.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorCobalt, colorGold}},
	{ID: "amamoma-presbyterian-model-basic", Slug: "amamoma-presbyterian-model-basic", Kind: "school", Name: "Amamoma Presbyterian Model Basic School", Classification: "Basic school · Presbyterian (mission), co-ed", Summary: "A Presbyterian model basic school at Amamoma, near the University of Cape Coast. Languages of instruction: English and Fante.", Jurisdiction: "Amamoma, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorCobalt, colorBrass}},
	{ID: "alec-jones-memorial-methodist-basic", Slug: "alec-jones-memorial-methodist-basic", Kind: "school", Name: "Rev. Alec Jones Memorial Methodist Basic School", Classification: "Basic school · Methodist (mission), co-ed", Summary: "A Methodist mission basic school in Cape Coast, named for the Rev. Alec Jones. Languages of instruction: English and Fante.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorMaroon, colorGold}},
	{ID: "ejp-brown-methodist-basic", Slug: "ejp-brown-methodist-basic", Kind: "school", Name: "E.J.P. Brown Methodist Basic School", Classification: "Basic school · Methodist (mission), co-ed", Summary: "A Methodist mission kindergarten and primary school in Cape Coast, named after E.J.P. Brown. Languages of instruction: English and Fante.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorMaroon, colorBrass}},
	{ID: "markin-memorial-methodist-basic", Slug: "markin-memorial-methodist-basic", Kind: "school", Name: "Rev. Markin Memorial Methodist Basic School", Classification: "Basic school · Methodist (mission), co-ed", Summary: "A Methodist mission basic school in Cape Coast, running primary and junior high classes. Languages of instruction: English and Fante.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorMaroon, colorGold}},
	{ID: "st-augustines-practice-jhs", Slug: "st-augustines-practice-jhs", Kind: "school", Name: "St. Augustine's Practice JHS", Classification: "Basic school (JHS) · Catholic (mission), co-ed", Summary: "A Catholic practice and demonstration junior high school in the Amanful quarter of Cape Coast, linked to St. Augustine's College. Languages of instruction: English and Fante.", Jurisdiction: "Amanful, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorLeafGreen, colorPaper}},
	//
	// Basic schools — public (Metropolitan Authority) and quasi-public.
	{ID: "ucc-basic-school", Slug: "ucc-basic-school", Kind: "school", Name: "UCC Basic School (University Primary & Junior High School)", Classification: "Basic school · quasi-public, co-ed", Summary: "A quasi-public basic school run by the University of Cape Coast on its campus, taking pupils from primary through junior high — and among the schools that also admit visually- and hearing-impaired children. Languages of instruction: English and Fante.", Jurisdiction: "UCC Campus, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorCobalt, colorGold}},
	{ID: "philip-quaque-girls-basic", Slug: "philip-quaque-girls-basic", Kind: "school", Name: "Philip Quaque Girls' Basic School", Classification: "Basic school · public, girls", Summary: "A historic public girls' basic school at Bakaano, Cape Coast — the girls' companion to the Philip Quaque Boys' School. Languages of instruction: English and Fante.", Jurisdiction: "Bakaano, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorMaroon, colorGold}},
	{ID: "jacob-wilson-sey-ma-basic", Slug: "jacob-wilson-sey-ma-basic", Kind: "school", Name: "Jacob Wilson Sey M/A Basic School", Classification: "Basic school · public, co-ed", Summary: "A public (Metropolitan Authority) basic school in Cape Coast named after the philanthropist Jacob Wilson Sey. Languages of instruction: English and Fante.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorDeepGreen, colorBrass}},
	{ID: "ekon-ma-basic", Slug: "ekon-ma-basic", Kind: "school", Name: "Ekon M/A Basic School", Classification: "Basic school · public, co-ed", Summary: "A public (Metropolitan Authority) basic school in the fishing suburb of Ekon, Cape Coast. Languages of instruction: English and Fante.", Jurisdiction: "Ekon, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorDeepGreen, colorGold}},
	{ID: "pedu-ma-basic", Slug: "pedu-ma-basic", Kind: "school", Name: "Pedu M/A Basic School", Classification: "Basic school · public, co-ed", Summary: "A public (Metropolitan Authority) basic school at Pedu, Cape Coast. Languages of instruction: English and Fante.", Jurisdiction: "Pedu, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorDeepGreen, colorBrass}},
	{ID: "kakomdo-ma-basic", Slug: "kakomdo-ma-basic", Kind: "school", Name: "Kakomdo M/A Basic School", Classification: "Basic school · public, co-ed", Summary: "A public (Metropolitan Authority) basic school at Kakomdo, Cape Coast. Languages of instruction: English and Fante.", Jurisdiction: "Kakomdo, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorDeepGreen, colorGold}},
	{ID: "kwaprow-ma-basic", Slug: "kwaprow-ma-basic", Kind: "school", Name: "Kwaprow M/A Basic School", Classification: "Basic school · public, co-ed", Summary: "A public (Metropolitan Authority) basic school at Kwaprow, near the University of Cape Coast. Languages of instruction: English and Fante.", Jurisdiction: "Kwaprow, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorDeepGreen, colorBrass}},
	{ID: "kwegyir-aggrey-basic", Slug: "kwegyir-aggrey-basic", Kind: "school", Name: "Kwegyir Aggrey Basic School", Classification: "Basic school · public, co-ed", Summary: "A public basic school in Cape Coast named after the educationist James Kwegyir Aggrey. Languages of instruction: English and Fante.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorGreen, colorGold}},
	{ID: "mensah-sarbah-basic", Slug: "mensah-sarbah-basic", Kind: "school", Name: "Mensah Sarbah Basic School", Classification: "Basic school · public, co-ed", Summary: "A public basic school in Cape Coast named after the statesman John Mensah Sarbah. Languages of instruction: English and Fante.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorGreen, colorBrass}},
	{ID: "police-basic-school-cape-coast", Slug: "police-basic-school-cape-coast", Kind: "school", Name: "Police Basic School", Classification: "Basic school · quasi-public, co-ed", Summary: "A quasi-public basic school run within the Ghana Police establishment in Cape Coast. Languages of instruction: English and Fante.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorCobalt, colorGold}},
	//
	// Special school and private.
	{ID: "aboom-special-school", Slug: "aboom-special-school", Kind: "school", Name: "Aboom Special School", Classification: "Special school · public, co-ed", Summary: "A public special school in the Aboom quarter of Cape Coast for children with special educational needs.", Jurisdiction: "Aboom, Cape Coast", Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorLeafGreen, colorBrass}},
	{ID: "cape-coast-international-school", Slug: "cape-coast-international-school", Kind: "school", Name: "Cape Coast International School", Classification: "Basic school · private, co-ed", Summary: "A private international-curriculum school in Cape Coast spanning kindergarten through senior high.", Jurisdiction: cityCapeCoast, Verified: true, VerifiedOn: verifiedRosterBatch, HouseColors: []string{colorRoyalBlue, colorGold}},
