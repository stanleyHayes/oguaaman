...
**Small gaps:** creator Account type-picker omits `institution`; Payouts ledger; creatorTypes migration for pre-existing business owners; `dev.sh` verify script; citizen upgrade screen is a soft CTA, not the planned screen.
